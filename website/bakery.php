...
<!--  1st image start -->
 <section>
    <img src="image/b19.png" style="width: 100%;margin-top: 80px">
 </section>
 <!-- 1st image end -->
 	...
 	<div class="container-fluid text-center">
 		...
 		<div class="row cake-img">
 			...
 			<div class="col-md-4">
 				...
 				<h6 class="details">food made by baking sugar, eggs, flour, etc; food cooked in small, flat, round shape by baking </h6>
 				<h3>RS-370</h3>
 			</div>
 		</div><!-- row end -->
 		...
 		<div class="row cake-img">
 			...
 			<div class="col-md-4">
 				...
 				<h3 class="n-item-name">Lemon and Ricotta Cake.</h3>
			...
			<div class="full">
				...
				<div>
					<form>
						...
						<div class="clear">
						<button type="button" class="btn btn-danger btn1">Submit</button>
					</div>
					</form>
				</div>
				</div>
